#
# Implements the localization and detection metrics with extensions to support multi-instance of the same class
#
...
# Segment Level Metrics Evaluation
...
class SELDMetrics(object):
    ...
    def update_seld_scores(self, pred, gt, eval_dist=False):
        '''
        Implements the spatial error averaging. Adds the multitrack extensions
